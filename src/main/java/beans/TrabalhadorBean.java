...
/**
 * Classe EJB que possui os m�todos de manipula��o e consulta do
 * reposit�rio de trabalhadores.
 * 
 * @author Denis Lopes
 *
 */
...
public class TrabalhadorBean {
	...
	/**
	 * Atualiza um trabalhador espec�fico no reposit�rio, utilizando o nome
	 * artistico.
	 * 
